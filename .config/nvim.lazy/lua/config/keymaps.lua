...
vim.keymap.set("n", "ö", "0", { noremap = true, silent = true })
vim.keymap.set("n", "Ö", ")", { noremap = true, silent = true })
vim.keymap.set("n", "ü", "-", { noremap = true, silent = true })
vim.keymap.set("n", "Ü", "_", { noremap = true, silent = true })
vim.keymap.set("n", "ó", "=", { noremap = true, silent = true })
vim.keymap.set("n", "Ó", "+", { noremap = true, silent = true })
vim.keymap.set("n", "ő", "[", { noremap = true, silent = true })
vim.keymap.set("n", "Ő", "{", { noremap = true, silent = true })
vim.keymap.set("n", "ú", "]", { noremap = true, silent = true })
vim.keymap.set("n", "Ú", "}", { noremap = true, silent = true })
